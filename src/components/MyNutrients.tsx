...
import {delFoodNum} from "../slices/foodNum.ts";
...
export function MyNutrients() {
    ...
    const ResetClick = () => {
        dispatch(changeNutrients({calorie: 0, carbohydrate: 0, protein: 0, fat: 0, sodium: 0}));
        dispatch(delFoodNum());
    }
    ...
    const iconImage = useMemo(() => {
        return {
            calorie: makeIconImage(calorie, "percent"),
            carbohydrate: makeIconImage(carbohydrate, "percent"),
            protein: makeIconImage(protein, "percent"),
            fat: makeIconImage(fat, "percent"),
            sodium: makeIconImage(mynutirents.sodium, "sodium"),
        }
    }, [calorie, carbohydrate, protein, fat, mynutirents.sodium]);
        ...
        <Box sx={{position: "fixed", bottom: 32, right: 32}}>
            ...
            >
                ...
                >
                    ...
                    <Button onClick={ResetClick} sx={{color: '#FFFFFFFF'}}>reset</Button>
